...
const Vision = () => {
  return (
    <div className="bg-black flex  items-center flex-col">
      <div className="flex h-[30vh] md:h-[40vh] w-[70%] justify-center items-center primary-color text-white  rounded-b-[100%]">
      ...
      <div className=" text-black py-10 flex justify-center items-center mt-2">
        <div className="flex md:w-[70%]">
          <div className="w-full mx-10 text-white h4-thin h5-sm-thin mt-10 text-justify">
